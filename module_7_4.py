...
print(f"Результат битвы: победа команды {name2 if score_1 < score_2 else name1}!")
print(f"Сегодня было решено {score_1+score_2} задач, в среднем по {((team1_time+team2_time)/(score_1+score_2)):6.1f} секунды на задачу!.")